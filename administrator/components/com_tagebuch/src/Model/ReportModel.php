...
/**
 * Item Model for an Tagebuch-Report.
 *
 * @since  1.6
 */

class ReportModel extends AdminModel implements WorkflowModelInterface
{
	 ...
	 * @since  1.6
	 */
	protected $text_prefix = 'COM_TAGEBUCH';
	 ...
	 * @since  3.4.4
	 */
	protected $associationsContext = 'com_tagebuch.item';
	...
	public function __construct($config = [], MVCFactoryInterface $factory = null, FormFactoryInterface $formFactory = null)
	{
		...
		$this->setUpWorkflow('com_tagebuch.report');
	}
//
//	/**
