...
class AssociationsHelper extends AssociationExtensionHelper
{
	 ...
	 * @since   3.7.0
	 */
	protected $extension = 'com_tagebuch';
	 ...
	 * @since   3.7.0
	 */
	protected $itemTypes = array('tagebuch', 'category');
	...
	public function getItem($typeName, $id)
	{
		...
		{
			case 'tagebuch':
				$table = Table::getInstance('TagebuchTable', 'Joomla\\Component\\Tagebuch\\Administrator\\Table\\');
				break;
