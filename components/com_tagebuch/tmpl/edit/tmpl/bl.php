...
<script type="text/javascript">
	Joomla.submitbutton = function(task)
	{
		...
		{
			<?php echo $this->form->getField('text_bl')->save(); ?>
	...
	echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'bl'));
        echo JHtml::_('bootstrap.addTab', 'myTab', 'bl', $title);
        
            echo $this->form->renderField('datum');
            echo $this->form->renderField('state');
            echo $this->form->renderField('text_bl');
        
	$title = JText::_( 'COM_TAGEBUCH_EDIT_ZUS_EINGABEN' );
        echo JHtml::_('bootstrap.endTab'); 
        echo JHtml::_('bootstrap.addTab', 'myTab', 'extra', $title);
        
            echo $this->form->renderField('bl_erstellt_von');
            echo $this->form->renderField('bl_erstellt');
            echo $this->form->renderField('bl_laenderung_von');
            echo $this->form->renderField('bl_laenderung');
        ...
        <input type="hidden" name="return" value="<?php echo $this->return_page;?>" />
         <input type="hidden" name="layout" value="BL" />
