...
<script type="text/javascript">
	Joomla.submitbutton = function(task)
	{
		...
		{
			<?php echo $this->form->getField('text_an')->save(); ?>
	...
	echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'an'));
        echo JHtml::_('bootstrap.addTab', 'myTab', 'an', $title);
        
            echo $this->form->renderField('datum');
            echo $this->form->renderField('sfan');
            echo $this->form->renderField('state');
            echo $this->form->renderField('text_an');
        
	$title = JText::_( 'COM_TAGEBUCH_EDIT_ZUS_EINGABEN' );
        echo JHtml::_('bootstrap.endTab'); 
        echo JHtml::_('bootstrap.addTab', 'myTab', 'extra', $title);
        
            echo $this->form->renderField('an_erstellt_von');
            echo $this->form->renderField('an_erstellt');
            echo $this->form->renderField('an_laenderung_von');
            echo $this->form->renderField('an_laenderung');
        ...
        <input type="hidden" name="return" value="<?php echo $this->return_page;?>" />
         <input type="hidden" name="layout" value="an" />
