...
<script type="text/javascript">
	Joomla.submitbutton = function(task)
	{
		...
		{
			<?php echo $this->form->getField('text_z2')->save(); ?>
	...
	echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'z2'));
        echo JHtml::_('bootstrap.addTab', 'myTab', 'z2', $title);
        
            echo $this->form->renderField('datum');
            echo $this->form->renderField('state');
            echo $this->form->renderField('text_z2');
        
	$title = JText::_( 'COM_TAGEBUCH_EDIT_ZUS_EINGABEN' );
        echo JHtml::_('bootstrap.endTab'); 
        echo JHtml::_('bootstrap.addTab', 'myTab', 'extra', $title);
        
            echo $this->form->renderField('z2_erstellt_von');
            echo $this->form->renderField('z2_erstellt');
            echo $this->form->renderField('z2_laenderung_von');
            echo $this->form->renderField('z2_laenderung');
        ...
        <input type="hidden" name="return" value="<?php echo $this->return_page;?>" />
         <input type="hidden" name="layout" value="Z2" />
