...
<div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <p>
                <?php echo JText::_('COM_TAGEBUCH_REPORT_SFAN').': '; ?>
                <strong>
                    <?php echo $this->item->sfan_name ? $this->item->sfan_name : Text::_( '..' ) ; ?>
                </strong>
                </p>
            </div>
        </div>
                ...
                <?php if ($params->get('show_field_erst_am')){?>
                    <div class="row">
                        ...
                        <div class="col-7 col-md-7">
                            <?php echo (($this->item->an_erstellt == '0000-00-00 00:00:00') || ($this->item->an_erstellt == '-'))
                                ? Text::_( '..' ) : HTMLHelper::_('date', $this->item->an_erstellt, $formatDay); ?>
                        </div>
                    </div>
                <?php } ?>
                <div class="row">
                    ...
                    <div class="col-7 col-md-7">
                        <?php echo ($this->item->an_erstellt_von_name != '') ? $this->item->an_erstellt_von_name : Text::_( '-' ); ?>
                    </div>
                </div>
                <div class="row">
                    <div class="col-5 col-md-5 text-right">
                    ...
                    <div class="col-7 col-md-7">
                        <?php echo (($this->item->an_laenderung == '0000-00-00 00:00:00') || ($this->item->an_laenderung == '-'))
                            ? Text::_( '..' ) : HTMLHelper::_('date', $this->item->an_laenderung, $formatDay); ?>
                    </div>
                </div>
                <div class="row">
                    <div class="col-5 col-md-5 text-right">
                    ...
                    <div class="col-7 col-md-7">
                        <?php echo ($this->item->an_laenderung_von_name != '') ? $this->item->an_laenderung_von_name : Text::_( '-' ) ; ?>
                    </div>
                </div>
            </div>
            <div class="col-10 col-md-10">
                <?php echo strlen($this->item->text_an) > 0 ? $this->item->text_an : HTMLHelper::image('images/blank.png' , Text::_('Empty') , $blank_image_attribs); ?>
            </div>
        </div>
    </div>