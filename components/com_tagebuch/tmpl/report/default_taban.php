    ...
    <div class="row">
        <div class="col-2 col-md-2 smaller">
            ...
            <?php if ($params->get('show_field_erst_am')){?>
                <div class="row">
                    ...
                    <div class="col-7 col-md-7">
                        <?php echo (($this->item->an_erstellt == '0000-00-00 00:00:00') || ($this->item->an_erstellt == '-') || ($this->item->an_erstellt == null))
                            ? Text::_( 'n.V.' ) : HTMLHelper::_('date', $this->item->an_erstellt, $formatDay); ?>
                    </div>
                </div>
            <?php } ?>
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-7 col-md-7">
                    <?php echo (($this->item->an_laenderung == '0000-00-00 00:00:00') || ($this->item->an_laenderung == '-')  || ($this->item->an_laenderung == null))
                        ? Text::_( 'n.V.' ) : HTMLHelper::_('date', $this->item->an_laenderung, $formatDay); ?>
                </div>
            </div>
            <div class="row">
                <div class="col-5 col-md-5 text-right">
