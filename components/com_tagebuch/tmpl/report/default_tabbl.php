    ...
    <div class="row">
        <div class="col-2">
            ...
            if ($params->get('access-edit-bl')){
                $url = Route::_($params->get('editlink').$this->item->id.'&layout=BL&return='.$returnPage);
                ?>
                <span class="sk-tip tip hasTooltip" title="<?php echo HTMLHelper::_('tooltipText', 'COM_TAGEBUCH_REPORT_EDIT_BL_DESC'); ?>">
            ...
            <?php if ($params->get('show_field_erst_am')){?>
                <div class="row">
                    ...
                    <div class="col-7 col-md-7">
                        <?php echo (($this->item->bl_erstellt == '0000-00-00 00:00:00') || ($this->item->bl_erstellt == '-')  || ($this->item->bl_erstellt == null))
                            ? Text::_( 'n.V.' ) : HTMLHelper::_('date', $this->item->bl_erstellt, $formatDay); ?>
                    </div>
                </div>
            <?php } ?>
            <div class="row">
                ...
                <div class="col-7 col-md-7">
                    <?php echo ($this->item->bl_erstellt_von_name != '') ? $this->item->bl_erstellt_von_name : Text::_( '-' ); ?>
                </div>
            </div>
            <div class="row">
                <div class="col-5 col-md-5 text-right">
                ...
                <div class="col-7 col-md-7">
                    <?php echo (($this->item->bl_laenderung == '0000-00-00 00:00:00') || ($this->item->bl_laenderung == '-') || ($this->item->bl_laenderung == null))
                        ? Text::_( 'n.V.' ) : HTMLHelper::_('date', $this->item->bl_laenderung, $formatDay); ?>
                </div>
            </div>
            <div class="row">
                <div class="col-5 col-md-5 text-right">
                ...
                <div class="col-7 col-md-7">
                    <?php echo ($this->item->bl_laenderung_von_name != '') ? $this->item->bl_laenderung_von_name : Text::_( '-' ) ; ?>
                </div>
            </div>
        </div>
        <div class="col-10 col-md-10">
            <?php echo (!($this->item->text_bl === null || $this->item->text_bl == '')) ? $this->item->text_bl : HTMLHelper::image('media/com_tagebuch/images/blank.gif' , Text::_('Empty') , $blank_image_attribs,true,-1) ?>
        </div>
    </div>
</div>