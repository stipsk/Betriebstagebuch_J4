        ...
        <div class="row">
            <div class="col-2 col-md-2 smaller">
                ...
                <?php if ($params->get('show_field_erst_am')){?>
                    <div class="row">
                        ...
                        <div class="col-7 col-md-7">
                            <?php echo (($this->item->z1_erstellt == '0000-00-00 00:00:00') || ($this->item->z1_erstellt == '-'))
                                ? Text::_( '..' ) : HTMLHelper::_('date', $this->item->z1_erstellt, $formatDay); ?>
                        </div>
                    </div>
                <?php } ?>
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-7 col-md-7">
                        <?php echo (($this->item->z1_laenderung == '0000-00-00 00:00:00') || ($this->item->z1_laenderung == '-'))
                            ? Text::_( '..' ) : HTMLHelper::_('date', $this->item->z1_laenderung, $formatDay); ?>
                    </div>
                </div>
                <div class="row">
                    <div class="col-5 col-md-5 text-right">
            ...
            <div class="col-10 col-md-10">
                <?php echo strlen($this->item->text_z1) > 0 ? $this->item->text_z1 : HTMLHelper::image('images/blank.png' , Text::_('Empty') , $blank_image_attribs); ?>
            </div>
        </div>
    </div>