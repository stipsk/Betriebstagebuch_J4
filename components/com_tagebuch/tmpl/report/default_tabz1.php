    ...
    <div class="row">
        <div class="col-2">
			...
			if ($params->get('access-edit-z1')){
				$url = Route::_($params->get('editlink').$this->item->id.'&layout=Z1&return='.$returnPage);
				?>
                <span class="sk-tip tip hasTooltip" title="<?php echo HTMLHelper::_('tooltipText', 'COM_TAGEBUCH_REPORT_EDIT_Z1_DESC'); ?>">
